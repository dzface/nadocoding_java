package quiz;
/*
ArrayList를 이용하여 학생별 프로그래밍 언어 자격증 최득정보를 관리하고,
자바 자격증을 보유한 학생 이름을 출력하시오

조건
학생이름 및 자격증 취득 정보를 위한 Studnet 클래스 생성
...
public class _Quiz_09 {
    public static void main(String[] args) {
        ...
        for (Student student : list) {
            if(student.cetification.equals("자바")) {
...
class Student {
    public String name;
    public String cetification;

    public Student(String name, String cetification) {
        this.name = name;
